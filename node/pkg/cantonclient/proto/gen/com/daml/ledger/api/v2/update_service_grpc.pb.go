...
func (c *updateServiceClient) GetUpdates(ctx context.Context, in *GetUpdatesRequest, opts ...grpc.CallOption) (UpdateService_GetUpdatesClient, error) {
	stream, err := c.cc.NewStream(ctx, &UpdateService_ServiceDesc.Streams[0], "/com.daml.ledger.api.v2.UpdateService/GetUpdates", opts...)
	if err != nil {
		return nil, err
	}
	x := &updateServiceGetUpdatesClient{stream}
...
func (c *updateServiceClient) GetUpdateByOffset(ctx context.Context, in *GetUpdateByOffsetRequest, opts ...grpc.CallOption) (*GetUpdateResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/com.daml.ledger.api.v2.UpdateService/GetUpdateByOffset", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *updateServiceClient) GetUpdateById(ctx context.Context, in *GetUpdateByIdRequest, opts ...grpc.CallOption) (*GetUpdateResponse, error) {
	out := new(GetUpdateResponse)
	err := c.cc.Invoke(ctx, "/com.daml.ledger.api.v2.UpdateService/GetUpdateById", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *updateServiceClient) GetUpdatesPage(ctx context.Context, in *GetUpdatesPageRequest, opts ...grpc.CallOption) (*GetUpdatesPageResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/com.daml.ledger.api.v2.UpdateService/GetUpdatesPage", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _UpdateService_GetUpdates_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(UpdateServiceServer).GetUpdates(m, &updateServiceGetUpdatesServer{stream})
}
...
func _UpdateService_GetUpdateByOffset_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/com.daml.ledger.api.v2.UpdateService/GetUpdateByOffset",
	}
...
func _UpdateService_GetUpdateById_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/com.daml.ledger.api.v2.UpdateService/GetUpdateById",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _UpdateService_GetUpdatesPage_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/com.daml.ledger.api.v2.UpdateService/GetUpdatesPage",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
