...
func TestDelegatedPauserSetConfigEvmToVaa_Errors(t *testing.T) {
	base := func() *nodev1.DelegatedPauserSetConfigEvm {
		return &nodev1.DelegatedPauserSetConfigEvm{
			...
			Threshold:      1,
			ExpiryDuration: 60,
			Signers:        []string{"0x1111111111111111111111111111111111111111"},
		}
	}
	...
	tests := []struct {
		...
		{"ChainIdZero", func(r *nodev1.DelegatedPauserSetConfigEvm) { r.ChainId = 0 }, "invalid chain_id"},
		{"ChainIdTooLarge", func(r *nodev1.DelegatedPauserSetConfigEvm) { r.ChainId = 1 << 17 }, "invalid chain_id"},
		...
		{"ZeroSigner", func(r *nodev1.DelegatedPauserSetConfigEvm) {
			r.Signers = []string{"0x0000000000000000000000000000000000000000"}
		}, "zero address"},
...
func TestDelegatedPauserSetConfigSolanaToVaa_Errors(t *testing.T) {
	...
	tests := []struct {
		...
		{"ChainIdZero", func(r *nodev1.DelegatedPauserSetConfigSolana) { r.ChainId = 0 }, "invalid chain_id"},
		{"ChainIdTooLarge", func(r *nodev1.DelegatedPauserSetConfigSolana) { r.ChainId = 1 << 17 }, "invalid chain_id"},
...
func TestBridgeSetPauserAddressesEvmToVaa(t *testing.T) {
	req := &nodev1.BridgeSetPauserAddressesEvm{
		...
		Pauser:        "0xaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa",
		Unpauser:      "0xbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbb",
	}
...
func TestBridgeSetPauserAddressesEvmToVaa_Errors(t *testing.T) {
	...
	tests := []struct {
		...
		{"ChainIdZero", func(r *nodev1.BridgeSetPauserAddressesEvm) { r.TargetChainId = 0 }, "invalid target_chain_id"},
		{"ChainIdTooLarge", func(r *nodev1.BridgeSetPauserAddressesEvm) { r.TargetChainId = 1 << 17 }, "invalid target_chain_id"},
...
func TestBridgeSetPauserAddressesSolanaToVaa_Errors(t *testing.T) {
	...
	tests := []struct {
		...
		{"ChainIdZero", func(r *nodev1.BridgeSetPauserAddressesSolana) { r.TargetChainId = 0 }, "invalid target_chain_id"},
		{"ChainIdTooLarge", func(r *nodev1.BridgeSetPauserAddressesSolana) { r.TargetChainId = 1 << 17 }, "invalid target_chain_id"},
