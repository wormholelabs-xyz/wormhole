//! Mollusk construction with the pinned sibling programs, and in-memory account helpers.
...
use crate::ids::{noreplay_program_id, shim_program_id, system_program_id};

/// Mollusk with `program_name` at `program_id` plus the pinned NoReplay and Shim binaries.
