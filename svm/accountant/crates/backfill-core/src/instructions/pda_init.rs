//! PDA creation through `CreateAccountAllowPrefund` (SIMD-0312). Mirrors
//! `accountant_operational_core::support::pda_init`, duplicated rather
//! than shared per `commit_log.rs`'s rationale.
//!
