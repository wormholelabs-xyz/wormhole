...
// ----------------------------------------------------------------------------
// submit_observations driver (carries the inline-secp guardian set)
// ----------------------------------------------------------------------------

/// Core-Bridge-style `GuardianSet` account for the inline secp path: raw 20-byte
/// keys, never-expiring, owned by the Core Bridge.
